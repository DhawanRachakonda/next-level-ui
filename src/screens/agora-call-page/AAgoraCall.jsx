...
class AgoraCallWindow extends React.Component {
  ...
  UNSAFE_componentWillMount() {
    ...
    this.client = AgoraRTC.createClient({
      mode:
        this.props.location.state.baseMode === 'rtc' ||
        this.props.location.state.baseMode === 'live'
  ...
  handleExit = (e) => {
    ...
    try {
      ...
      this.props.history.push('agora-page');
    }
  };
      ...
      navigator.mediaDevices
        ...
        .then(function (stream) {
          ...
          _this.setState({
            ...
            vertical: 'top',
            horizontal: 'center',
            message: 'Camera and Audio options are available',
          });
        })
        .catch(function (err) {
          /* handle the error */
...
export default withRouter(AgoraCallWindow);
